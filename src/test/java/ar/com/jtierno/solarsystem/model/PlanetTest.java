...
public class PlanetTest {
    ...
    public void testPositionPrediction() {
        ...
        Vector position = planet.predictPosition(0L);
        ...
        position = planet.predictPosition(1L);
        ...
        position = planet.predictPosition(2L);
        ...
        position = planet.predictPosition(3L);
        ...
        position = planet.predictPosition(4L);
        ...
        position = planet.predictPosition(5L);
        ...
        position = planet.predictPosition(6L);
        ...
        position = planet.predictPosition(7L);
        ...
        position = planet.predictPosition(8L);
        ...
        position = planet.predictPosition(9L);
